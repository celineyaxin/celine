...
if __name__ == "__main__":
    ...
    # 配置文件路径和参数
    INPUT_FILE = "/Users/chenyaxin/Desktop/websitdata/merge_data6/delete_hostility.csv"
    PRIMARY_SAMPLE_FILE = "/Users/chenyaxin/Desktop/审稿修改/分类数据/投诉数据_一级样本_10000条.csv"
    OUTPUT_DIR = "/Users/chenyaxin/Desktop/审稿修改/分类数据"
