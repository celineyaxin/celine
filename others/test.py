...
class CninfoSpider:
    def __init__(self):
        ...
        # 创建下载目录
        self.base_dir = '/Users/chenyaxin/Desktop/章程/downloads'
        if not os.path.exists(self.base_dir):
            os.makedirs(self.base_dir)

        # 创建结果目录
        self.results_dir = '/Users/chenyaxin/Desktop/章程/results'
                                ...
                                with pdfplumber.open(pdf_path) as pdf:
                                    ...
                                    for change in changes:
                                        article_changes_data.append({
                                            ...
                                            'board_meeting_date': basic_info['board_meeting_date'],
                                            'shareholders_meeting_date': basic_info['shareholders_meeting_date']
                                        })
                            except Exception as e:
...
def main():
    spider = CninfoSpider()
    # 从Excel文件读取股票代码
    excel_path = '/Users/chenyaxin/Desktop/章程/股票代码.xlsx'  # Excel文件路径
